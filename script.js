...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function showText(){
    ...
    // Message script
    message2.innerHTML = "Hello, <br/><br/>     My name is " + name2 + " and I hope this message finds you well. I am writing to express my deep concern about the current state of healthcare for incarcerated women and to urge " + recipient2 + " to take meaningful steps toward improving the conditions and access to " + issue2 + " within correctional facilities. <br/><br/>     Women in incarceration face unique health challenges, including reproductive care, mental health support, and treatment for substance use disorders. Unfortunately, many facilities lack adequate medical resources, resulting in delayed or insufficient care that can have long-term consequences on their well-being and dignity. <br/><br/>     Ensuring that incarcerated women receive proper and timely healthcare is not only a matter of public health, but also of basic human rights. I respectfully ask you to review current policies and practices and consider increased funding, oversight, and training to address these pressing issues. <br/><br/>     Your leadership can make a real difference in the lives of some of the most vulnerable members of our society. Thank you for your attention to this matter, and I hope you will take meaningful action to protect and improve the health of incarcerated women. <br/><br/>     Sincerely, <br/>" + name2;
  }
});
